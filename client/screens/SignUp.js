...
const SignUp = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={{color:'#0A5CFE'}} onPress={handleForgotPassword}>Forgot Password ?</Text>
      <Text style={{marginTop: 20, marginBottom: 10}}>OTHER LOG IN METHODS</Text>

      {
        btns.map( (btn, index) => {
          return(
            <TouchableOpacity key={index} style={styles.btns} onPress={handleLogin}>
              <Image 
